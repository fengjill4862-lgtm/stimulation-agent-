...
class RhsHeader:
    ...
    desired_lower_settle_bandwidth_hz: float = float("nan")
...
def _read_header(fid, path: Path, file_size: int) -> RhsHeader:
    ...
    desired_dsp_cutoff_frequency = _read_scalar(fid, "f")
    desired_lower_bandwidth = _read_scalar(fid, "f")
    desired_lower_settle_bandwidth = _read_scalar(fid, "f")
    ...
    return RhsHeader(
        ...
        desired_dsp_cutoff_hz=float(desired_dsp_cutoff_frequency),
        desired_lower_bandwidth_hz=float(desired_lower_bandwidth),
        desired_lower_settle_bandwidth_hz=float(desired_lower_settle_bandwidth),
