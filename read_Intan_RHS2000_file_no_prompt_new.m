function [amplifier_data, frequency_parameters] = read_Intan_RHS2000_file_no_prompt_new(file, path)

% read_Intan_RHS2000_file_no_prompt_new
%
...
%        read_Intan_RHS2000_file_no_prompt_new(file, path)
% >> whos
...
if (fid == -1)
    error('Could not open RHS file: %s', filename);
end
